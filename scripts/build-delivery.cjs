...
for(const [md,html] of [['TECHNICAL.md','index.html'],['QUICKSTART.md','QUICKSTART.html'],['DISTRIBUTION.md','DISTRIBUTION.html']])write('docs/'+html,shell(markdown(read('docs/'+md))));
